        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-10 mt-4">
          <div>
            <h1 className="text-2xl font-medium tracking-tight text-gradient">
              Reward Rules Diagnostic
            </h1>
            <p className="text-muted-foreground mt-1.5 text-sm">
              This page helps identify why reward rules aren't showing up for
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <Badge variant="outline">
                  {result.orphanedCardTypeIds.length}
                </Badge>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="space-y-4">
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    ...
                    matching rules exist. Update the payment method name/issuer
                    or create matching reward rules.
                  </AlertDescription>
                </Alert>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    These reward rules exist but don't match any payment
                    methods. They won't be used.
                  </AlertDescription>
                </Alert>
          ...
          {result.mismatches.length === 0 &&
            result.orphanedCardTypeIds.length === 0 && (
              <Alert>
                ...
                <AlertDescription>
                  All payment methods have matching reward rules. If you're
                  still seeing issues, check the browser console for errors.
                </AlertDescription>
              </Alert>
            )}
        </div>
