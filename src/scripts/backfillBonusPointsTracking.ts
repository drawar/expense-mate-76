...
function getPeriodKey(
  ...
  // This groups all transactions in the promo period together
  const periodDate =
  ...
  // For promotional periods, always use statementDay=1
  // (matches BonusPointsTracker.getCapUsageForRules line 342)
  const effectiveStatementDay = periodType === "promotional" ? 1 : statementDay;

  return { year, month, statementDay: effectiveStatementDay };
}
