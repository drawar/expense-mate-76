...
async function setupCitibankRewardsCard() {
  ...
  try {
    ...
    // Travel-related merchant names to EXCLUDE from online bonus
    // Provides a second layer of exclusion in case MCC is not correctly assigned
    const travelMerchantNames = [
      // Airlines
      "singapore airlines",
      "sq",
      "sia",
    ...
    // We exclude travel MCCs and merchant names here
