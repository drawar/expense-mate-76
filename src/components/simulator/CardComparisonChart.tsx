...
interface CardComparisonChartProps {
   ...
   */
  selectedMilesCurrencyId: string;

  /**
   * Callback when miles currency changes - passes the currency ID
   */
  onMilesCurrencyChange: (currencyId: string) => void;
            ...
            >
              ...
              >
                ...
                <p style={{ fontSize: "var(--font-size-label)" }}>
                  Enter transaction details above to see which card earns the
                  most rewards
                </p>
              </div>
            </div>
