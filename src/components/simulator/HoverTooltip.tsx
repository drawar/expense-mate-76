...
export function HoverTooltip({
  ...
  const getTierCapInfo = (): string[] => {
    ...
    if (calculation.monthlyCap !== undefined && calculation.remainingMonthlyBonusPoints !== undefined) {
      ...
      >
        ...
        <div className="space-y-2 mb-3">
          <div className="flex justify-between">
            ...
            <span className="font-medium">{formatNumber(calculation.basePoints)}</span>
          </div>
          
          <div className="flex justify-between">
            <span style={{ color: theme.fadedText }}>Bonus points:</span>
            <span className="font-medium">{formatNumber(calculation.bonusPoints)}</span>
          </div>
          ...
          >
            ...
            <span className="font-semibold">{formatNumber(calculation.totalPoints)}</span>
          </div>
        </div>
        ...
        {conversionRate !== null && convertedMiles !== null && (
          <div className="mb-3 pb-3 border-b" style={{
            ...
            <div className="flex justify-between mb-1">
              ...
              <span className="font-medium">{conversionRate.toFixed(2)} : 1</span>
            </div>
            <div className="flex justify-between">
