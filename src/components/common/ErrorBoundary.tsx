...
class ErrorBoundary extends Component<Props, State> {
  ...
  static getDerivedStateFromError(error: Error): State {
    // Stale-chunk errors after a fresh deploy are recoverable via a page
    // reload — don't paint the error UI, the reload will replace the page.
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    if (isChunkLoadError(error)) {
      // Fresh deploy — old HTML references gone chunks. Reload once.
