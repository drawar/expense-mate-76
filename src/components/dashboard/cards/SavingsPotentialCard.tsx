...
const SavingsPotentialCard: React.FC<SavingsPotentialCardProps> = ({
  ...
  const formattedValues = React.useMemo(() => {
    ...
    const savingsPotentialFormatted = formatCurrency(analysis.savingsPotential, currency);
    const savingsProgressRounded = Math.round(analysis.savingsProgress);
    const discretionarySpendingFormatted = formatCurrency(analysis.discretionarySpending, currency);
