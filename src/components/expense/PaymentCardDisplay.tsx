  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        <div className={`text-white ${textClasses} font-medium line-clamp-2`}>
          {paymentMethod.name}
        </div>
      ...
      <div className="text-white">
        {paymentMethod.type === "credit_card" &&
          paymentMethod.lastFourDigits && (
            <div className="flex items-center justify-between">
              ...
              <div className={`${lastFourClasses} font-mono tracking-wider`}>
                {paymentMethod.lastFourDigits}
              </div>
            </div>
          )}
        {paymentMethod.issuer && (
          <div
            className={`${issuerClasses} text-white/70 mt-1 font-medium uppercase`}
          >
            {paymentMethod.issuer}
          </div>
        )}
