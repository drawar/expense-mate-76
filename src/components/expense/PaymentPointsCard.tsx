...
interface PaymentPointsCardProps {
  type: 'uob-platinum' | 'uob-signature' | 'citibank-rewards';
  amount: number;
  currency?: string;
  mcc?: string;
  isOnline?: boolean;
...
export const PaymentPointsCard: React.FC<PaymentPointsCardProps> = ({
  type,
  amount,
  currency,
  mcc,
