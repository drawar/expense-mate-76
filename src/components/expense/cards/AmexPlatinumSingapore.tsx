...
/**
 * Extended props interface for AmexPlatinumSingaporeCard
 */
export interface AmexPlatinumSingaporeCardProps extends BaseRewardCardProps {
  usedBonusPoints: number;
}

/**
 * American Express Platinum Singapore Implementation
 * 
 * Card features:
 ...
 * - Card Name: Platinum Singapore
 * - Every $1.60 spent in SGD earns 2 MR points
 * - Points are rounded to the nearest whole point
 * - No monthly cap
 * - No bonus categories
 */
export class AmexPlatinumSingaporeCard extends BaseRewardCard<AmexPlatinumSingaporeCardProps> {
  /**
 ...
 */
export const AmexPlatinumSingaporeWrapper: React.FC<AmexPlatinumSingaporeCardProps> = (props) => {
  return <AmexPlatinumSingaporeCard {...props} />;
};