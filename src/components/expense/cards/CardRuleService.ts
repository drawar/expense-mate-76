  ...
  private loadSampleRules(): RuleConfiguration[] {
    const sampleRules: RuleConfiguration[] = [
      ...
      },
      {
        ...
        cardType: 'uob-preferred-platinum',
        enabled: true,
        rounding: 'nearest5',
        basePointRate: 0.4,
        bonusPointRate: 3.6,
      ...
      },
      {
        ...
        cardType: 'td-aeroplan-visa-infinite',
        enabled: true,
        rounding: 'nearest',
        basePointRate: 1,
        bonusPointRate: 0.5,
